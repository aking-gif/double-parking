  ...
  function injectStyles(){
    ...
    s.textContent = `
      ...
      .arsan-topbar{
        ...
        border-inline-start:1px solid rgba(212,168,60,.2) !important;
      ...
      .arsan-topbar-btn:hover{
        background:rgba(212,168,60,.15) !important;
        border-color:rgba(212,168,60,.3) !important;
      }
      .arsan-topbar-btn.primary{
        background:linear-gradient(180deg, #d4a83c, #b89030) !important;
        color:#fff !important;
      ...
      #arsan-fab{
        ...
        display:grid;
        place-items:center;
        box-shadow:0 4px 14px rgba(212,168,60,.35), 0 2px 6px rgba(0,0,0,.15);
      ...
      #arsan-fab:hover{
        ...
        box-shadow:0 6px 20px rgba(212,168,60,.45), 0 3px 10px rgba(0,0,0,.2);
      }
